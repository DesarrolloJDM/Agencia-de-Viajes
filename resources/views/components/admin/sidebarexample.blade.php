  ...
  <div class="sidebar-wrapper">
    <nav class="mt-2" aria-label="Main navigation">
      ...
      >
        ...
        {{-- Seccion Theme Generate Fin --}}

        {{-- Seccion Widgets Inicio --}}
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="./layout/collapsed-sidebar-without-hover.html" class="nav-link">
                <i class="nav-icon bi bi-circle"></i>
                <p>
                  Sidebar Mini <small>+ Collapsed + No Hover</small>
                </p>
              </a>
            </li>
            <li class="nav-item">
        ...
        {{-- Seccion Layout Options Fin --}}
        
        {{-- Seccion UI Elements Inicio --}}
        <li class="nav-item">
          <a href="#" class="nav-link">
        ...
        {{-- Seccion UI Elements Fin --}}
        
        {{-- Seccion Mailbox Inicio --}}
        <li class="nav-item">
          <a href="#" class="nav-link">
        ...
        {{-- Seccion Example/Auth Fin --}}

        {{-- Seccion Multi Level Inicio --}}
        <li class="nav-header">
          MULTI LEVEL EXAMPLE
        </li>
        <li class="nav-item">
        ...
        {{-- Seccion Multi Level Fin --}}

        {{-- Seccion Labels Inicio --}}
        <li class="nav-header">
          LABELS
        </li>
        <li class="nav-item">
